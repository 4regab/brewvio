...
// EF Core database context for Brewvio: exposes the entity sets and configures the schema.
public class BrewvioDbContext(DbContextOptions<BrewvioDbContext> options) : DbContext(options)
{
    ...
    // Configures indexes, decimal precision, optimistic concurrency, and FK delete behavior for the model.
    // modelBuilder: the EF Core model builder used to configure entities
    // Configures indexes, decimal precision, optimistic concurrency, and FK delete behavior for the model.
    // modelBuilder: the EF Core model builder used to configure entities
